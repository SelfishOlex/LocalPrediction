...
{
    LocalPlayerControlsRequestBus::Event( GetEntityId(), &LocalPlayerControlsRequestBus::Events::MoveForward, state );
...
{
    LocalPlayerControlsRequestBus::Event( GetEntityId(), &LocalPlayerControlsRequestBus::Events::MoveBackward, state );
...
{
    LocalPlayerControlsRequestBus::Event( GetEntityId(), &LocalPlayerControlsRequestBus::Events::StrafeLeft, state );
...
{
    LocalPlayerControlsRequestBus::Event( GetEntityId(), &LocalPlayerControlsRequestBus::Events::StrafeRight, state );
